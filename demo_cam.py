...
APPID = b'AM5tjxm512bHSDtB4yXUGsave4pjWtbJzoPBVFcsDtVn'
SDKKey = b'3oB9ZbwuxpVgm9K4jHGYKUxXz6tPsSK1Em33jrYxwwAK'
...
def start_monitoring():
    ...
    print('face_Features==',face_Features)
    ...
    # cap = cv2.VideoCapture("http://192.168.43.251:8081/")  # cv2.CAP_DSHOW
